...
if(isset($_POST['login']))
  {
    ...
    $email=($_POST['email']);
    $phone=($_POST['phone']);
    $query=("INSERT INTO users (username, password, first_name, last_name, email, phone) VALUES ('$username', '$password', '$first_name', '$last_name', '$email', '$phone')");
			...
			<h2 align="center">Penny Pincher</h2>
					...
					<form role="form" action="" method="post" id="" name="login">
						<fieldset>
							...
							<div class="checkbox">
								<button type="submit" value="login" name="login" action='index.php' class="btn btn-primary">Register</button><span style="padding-left:250px">
							</div>
							</fieldset>
					</form> 
					<form>
